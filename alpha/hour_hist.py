...
class GetHourHist(object):
    ...
    def main(self):
        ...
        gmt = GetHourHist(self.symbol_list,self.exchanges)

        threads = [threading.Thread(target=gmt.get_hour_hist, args=(symbol,)) for symbol in self.symbol_list]
